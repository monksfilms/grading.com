const FILMS = [
  ...
  },
  {
    ...
    description: "Pastel editorial francês. Tons creme, bege e caramelo com toques de cor saturada nos storybook moments.",
  ...
  },
  {
    ...
    description: "Deserto americano dos anos 50. Laranja-areia intenso, céu azul contrastante, pastéis desbotados pelo sol.",
  ...
  },
  {
    ...
    description: "P&B ortocromático brutal. Emula película de 1890 com ortocromático, grão pesado, halos de luz e vinheta forte. Formato quase quadrado 1.19:1.",
    ...
    effects: [
      ...
      { name: "Glow", app: "FCP", param: "Amount / Radius / Threshold", value: "0.45 / 24px / 0.72", note: "Halos de glow ao redor das luzes — especialmente o farol. Dá o efeito de halação de lente antiga" },
      ...
      { name: "Sharpen", app: "FCP", param: "Amount", value: "15%", note: "Levíssimo, só para dar textura à película. Não exagerar." },
      { name: "Crop (Aspect Ratio)", app: "FCP", param: "Custom", value: "1.19:1 (ex: 1434×1202)", note: "O filme foi rodado em formato quase quadrado. Aplique crop nas bordas laterais para replicar o look" }
    ]
  }
];
